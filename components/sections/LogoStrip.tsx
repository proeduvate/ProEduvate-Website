...
export function LogoStrip({
  ...
  return (
    <section className={dark ? "border-t border-white/10 bg-black py-14" : "bg-surface-2 py-14"}>
      <Container>
        <AnimatedReveal>
          <p
            className={
      ...
      <div className="relative overflow-hidden">
        <div
          className={
            ...
            (dark ? "from-black to-transparent" : "from-surface-2 to-transparent")
          }
        />
        <div
          className={
          ...
          {loop.map((name, i) => (
            <span
              ...
              className={
                ...
                (dark ? "text-white/40 hover:text-white/90" : "text-gray-400 hover:text-gray-300")
              }
            >
              {name}
            </span>
