          ...
          {values.map((value, i) => {
            ...
            return (
              <AnimatedReveal key={value.title} delay={i * 0.05}>
                <div
                  className={cn(
                    "flex flex-col gap-4 border-b border-white/10 py-10 md:flex-row md:items-start md:gap-12 md:py-14"
                  )}
                >
                  <div className="flex items-center gap-4 md:w-2/5">
                    ...
                    <h3 className="font-display text-3xl font-medium text-chalk sm:text-4xl md:text-5xl">
                      {value.title}
                    </h3>
                  </div>
                  <p className="text-base leading-relaxed text-gray-400 md:w-3/5 md:pt-2 md:text-lg">
